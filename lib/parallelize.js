    ...
    n = {
      11: function (e, t, o) {
        ...
        const r = o(553),
          ...
          l = new Set();
        let s = !1;
        const c = (e) => Date.now() - e < r.TASKS_LIMIT;
        t.parallelize = function (e, t = {}) {
          const o = Object.assign({ debug: !1 }, t);
          return function (...t) {
            const d = o.debug ? i.statLogger(e.name || "anonymous") : void 0,
              u = { generator: e(...t), aborted: !1, logger: d },
              f = new Promise((e, t) => {
                (u.resolve = e), (u.reject = t);
              });
            if (
              (l.add(u),
              (f.abort = function (e = !0) {
                const t = u;
                (t.aborted = !0),
                  e ? t.resolve(r.Aborted) : t.reject(r.Aborted);
              }),
              (function () {
